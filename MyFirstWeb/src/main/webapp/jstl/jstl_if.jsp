<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 페이지 내부에서 c태그라이브러리를 써서 태그화 하고싶다면 디렉티브를 이용해 선언 --%>
...
<body>
     ...
     <c:if test="${param.name eq '이순신'}">
      ...
      <c:out value="${fName }의 나이는 ${fAge}입니다."/><br>
</body>
</html>